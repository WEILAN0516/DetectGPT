...
args = {
    ...
    'imagebind_ckpt_path': '/tmp/pycharm_project_444/pretrained_ckpt/imagebind_ckpt/imagebind_huge.pth',
    # 'vicuna_ckpt_path': '../pretrained_ckpt/vicuna_ckpt',
    'vicuna_ckpt_path': '/tmp/pycharm_project_444/pretrained_ckpt/vicuna_ckpt',
    # 'anomalygpt_ckpt_path': '../pretrained_ckpt/train_supervised/pytorch_model.pt',
    'anomalygpt_ckpt_path': '/tmp/pycharm_project_444/pretrained_ckpt/train_supervised/pytorch_model.pt',
    # 'delta_ckpt_path': '../pretrained_ckpt/pandagpt_ckpt/pytorch_model.pt',
    'delta_ckpt_path': '/tmp/pycharm_project_444/pretrained_ckpt/pandagpt_ckpt/pytorch_model.pt',
    'stage': 2,
    'max_tgt_len': 128,
    'lora_r': 32,
    'lora_alpha': 32,
...
delta_ckpt = torch.load(args['delta_ckpt_path'], map_location=torch.device('cuda')) #cpu
model.load_state_dict(delta_ckpt, strict=False)
delta_ckpt = torch.load(args['anomalygpt_ckpt_path'], map_location=torch.device('cuda')) #cpu
model.load_state_dict(delta_ckpt, strict=False)
